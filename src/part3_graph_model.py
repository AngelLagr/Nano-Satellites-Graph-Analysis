...
for density, file_path in file_paths.items():
    ...
    with open(analysis_file_path, "w") as f:
        ...
        if shortest_paths_lengths:
            ...
            f.write(f"Longueur moyenne des plus courts chemins ({density}, {max_range} km): {round(avg_shortest_path_length/100000,1)} km\n\n")
        ...
        plt.title(f'Distribution des plus courts chemins ({density}, {max_range} km)')
        ...
        f.write(f"Nombre de plus courts chemins ({density}, {max_range} km): {num_shortest_paths}\n\n")
