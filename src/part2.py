    ...
    for max_range in ranges:
        ...
        with open(analysis_file_path, "w") as f:
            ...
            if shortest_paths_lengths:
                ...
                f.write(f"Longueur moyenne des plus courts chemins (sans poids sur les arrêtes) ({density}, {max_range} m): {avg_shortest_path_length}\n\n")
            ...
            f.write(f"Nombre de plus courts chemins (sans poids sur les arrêtes) ({density}, {max_range} m): {num_shortest_paths}\n\n")
